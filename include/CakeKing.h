...
class CakeKing : public Enemy
{
	...
	const float			__CAKEKING_MAX_LIFE = 3000;
	const float			__CAKEKING_SPEED = 200;
	const float			__CAKEKING_DASH_SPEED = 700;
	const float			__CAKEKING_DASH_MIN_DISTANCE = 400;

	const float			__CAKEKING_LIFE_INCREMENTATION_COEFFICIENT = 1.056467309f;
	const float			__CAKEKING_DAMAGES_INCREMENTATION_COEFFICIENT = 1.083798387f;

	const float			__CAKEKING_SPECIAL_ABILITY_COOLDOWN = 0.5f;

	const float			__CAKEKING_SPECIAL_ATTACK_COOLDOWN = 1.2f;
