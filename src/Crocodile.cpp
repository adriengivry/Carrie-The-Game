...
void Crocodile::GenerateStats()
{
	...
	m_maxLife = CalculateStat(__CROCODILE_LIFE, __CROCODILE_LIFE_INCREMENTATION_COEFFICIENT, __CROCODILE_MAX_LIFE);
	m_damages = CalculateStat(__CROCODILE_DAMAGES, __CROCODILE_DAMAGES_INCREMENTATION_COEFFICIENT, __CROCODILE_MAX_DAMAGES);
}
