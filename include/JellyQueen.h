...
class JellyQueen : public Enemy
{
	...
	const float			__JELLYQUEEN_MAX_LIFE = 3000;
	...
	const float			__JELLYQUEEN_LIFE_INCREMENTATION_COEFFICIENT = 1.056467309f;
	const float			__JELLYQUEEN_DAMAGES_INCREMENTATION_COEFFICIENT = 1.083798387f;
