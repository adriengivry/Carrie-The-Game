...
class JellyBear : public Enemy
{
	...
	const float			__JELLYBEAR_MAX_LIFE			= 650;
	const float			__JELLYBEAR_MAX_DAMAGES			= 8;

	const float			__JELLYBEAR_SPECIAL_ABILITY_COOLDOWN = 0.5f;

	const float			__JELLYBEAR_LIFE_INCREMENTATION_COEFFICIENT		= 1.1f;
	const float			__JELLYBEAR_DAMAGES_INCREMENTATION_COEFFICIENT	= 1.05f;
